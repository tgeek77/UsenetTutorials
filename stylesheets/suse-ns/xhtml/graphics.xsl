...
<xsl:template match="d:graphic">
  <xsl:choose>
    <xsl:when test="../d:inlineequation">
...
<xsl:template match="d:mediaobject|d:mediaobjectco">
  ...
  <xsl:variable name="align">
    <xsl:value-of select="$object/d:imagedata[@align][1]/@align"/>
  </xsl:variable>
...
<xsl:template match="d:imagedata">
  ...
  <xsl:choose>
    ...
    <xsl:otherwise>
      ...
      <xsl:variable name="phrases" select="ancestor::d:mediaobject/d:textobject[d:phrase]
