...
<xsl:stylesheet 
  ...
  <xsl:import href="http://docbook.sourceforge.net/release/xsl-ns/current//chunk-common.xsl" />
  <xsl:include href="http://docbook.sourceforge.net/release/xsl-ns/current//chunk-code.xsl" />
