...
<xsl:template match="d:title" mode="footer">
...
<xsl:template name="footer.leftside">
   <xsl:param name="title">
     <xsl:choose>
       <xsl:when test="ancestor-or-self::d:book/d:bookinfo/d:title">
         <xsl:apply-templates
          select="ancestor-or-self::d:book/d:bookinfo/d:title" mode="footer"/>
       </xsl:when>
       <xsl:when test="ancestor-or-self::d:info/d:title">
         <xsl:apply-templates select="ancestor-or-self::d:book/d:info/d:title" mode="footer"/>
       </xsl:when>
       <xsl:when test="ancestor-or-self::d:book/d:title">
         <xsl:apply-templates select="ancestor-or-self::d:book/d:title" mode="footer"/>
       </xsl:when>
       <xsl:otherwise>
...
<xsl:template name="footer.rightside">
 <xsl:variable name="title">
  <xsl:apply-templates select="d:title" mode="footer"/>
 </xsl:variable>
